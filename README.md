...
- `generator(x, μx, σx)` returns the infinitesimal generator 𝔸: <img src="img/generator.png" height ="50%" width = "50%">

- `stationary_distribution(x, μx, σx)` returns the stationary distribution of `x`, i.e. the left principal eigenvector of the operator 𝔸 <br> <img src="img/stationary.png" height ="35%" width = "35%">
