...
- `hansen_scheinkman_decomposition(x, μx, σx, μM, σM)` returns the Hansen-Scheinkman decomposition of `M`, i.e. the principal eigenvectors and the principal eigenvalue of 𝔸:
