...
- `generator(x, μx, σx)` returns the infinitesimal generator of `x` <img src="img/generator.png" height ="60%" width = "60%">

- `stationary_distribution(x, μx, σx)` returns the stationary distribution of `x`, i.e. the solution of <img src="img/stationary.png" height ="40%" width = "40%">
