...
- `stationary_distribution(x, μx, σx)` returns the left principal eigenvector of the infinitesimal generator  𝔸 <br> <img src="img/stationary.png" height ="35%" width = "35%">
...
- `generator(x, μx, σx, μM, σM)` returns the infinitesimal generator of tilted by `M`, 𝔸, defined as <br> <img src="img/generator_tilted.png" height ="70%" width = "70%">
